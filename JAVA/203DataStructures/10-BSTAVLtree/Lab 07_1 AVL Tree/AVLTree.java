...
public class AVLTree<E extends Comparable<E>> extends BST<E> {
	  ...
	  public boolean insert(E o) {
	    ...
	    if (!successful)
	      ...
	      balancePath(o);
	      // Balance from o to the root if necessary
	    }
	...
	private E find(int k, chapter26.BST.TreeNode<E> root) {
		AVLTreeNode<E> a = (AVLTreeNode<E>) root.right;
		AVLTreeNode<E> b = (AVLTreeNode<E>) root.left;
		AVLTreeNode<E> isRoot = null;
		
		if(a == null && k == 1) {
			isRoot = (AVLTreeNode<E>) root.element;
			return isRoot.element;
		}
		if(a == null && k == 2) {
			isRoot = (AVLTreeNode<E>) b.element;
			return isRoot.element;
		}
		if(k <= a.size){
			find(k,a);
